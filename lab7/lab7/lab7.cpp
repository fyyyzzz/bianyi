...
int word()
{
	...
	char yunsuanfu[11] = { '+','-','*','/','<','>','=','!','%','&','|' };
	char jiefu[9] = { ',',';','(',')','{','}','[',']','#' };
	const char* guanjianzi[20] = { "int","if","else","then","do","while","break","continue","switch","return","when","for","double","main","break","include","short","long","float","char", };
...
int main()
{
	FILE* fp;
	int n = 100;
	cout << "\n***IF-ELSE条件语句的翻译程序设计（LR方法、输出四元式）***" << endl;
	initGrammar();
	cout << "请输入文件名:";
